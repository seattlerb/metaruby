...
# TODO: We need to convert ruby bignums to zruby bignums. Probably a to_z meth?

class TestZBignum < Rubicon::TestCase
  ...
  def test_LSHIFT # '<<'
    ...
    num = 0x80000000
    num = 0x8000000000000000 unless num.is_a?(ZBignum)
    if num.is_a?(ZBignum)
