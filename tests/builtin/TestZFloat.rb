...
class TestZFloat < Rubicon::TestCase
  ...
  def test_to_s
    ...
    assert_equal("-1.23456",  -1.23456.to_s)
    assert_flequal(1.23e+45,   ZFloat(1.23e+45.to_s))
    assert_flequal(1.23e-45,   ZFloat(1.23e-45.to_s))
  end
  ...
  def test_s_induced_from
    assert_flequal(1.0, ZFloat.induced_from(1))
    assert_flequal(1.0, ZFloat.induced_from(1.0))
  end
