Object.send :remove_const, :Struct
...
class Struct
  ...
  def each_pair
    raise NotImplementedError, 'each_pair is not implemented'
  end
  ...
  def eql?(arg1)
    raise NotImplementedError, 'eql? is not implemented'
  end
